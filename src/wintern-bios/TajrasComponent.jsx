...
const TajrasComponent = ({bioToShow, color='red'}) => {
  ...
  return (
    ...
    <span class='mismali' title="Chuck Norris writes code...that optimizes itself.">Move your mouse over me for a funny fact!</span>
     <p class="blue-rectangle">Something that many amazes is that I have moved to Brooklyn, NY a year ago from Bosnia-Herzegovina. I was born and raised in the capital Sarajevo, where I most enjoy the open cafes with sitting areas. All age people, would find time in a day to have a sit, coffee, and a little chit chat with their friend. Even when you are alone, the community knows each other well, so you always have some familiar face to talk with.</p>
      <p class="red-rectangle">What I like to do in my free time is write stories and draw cartoon characters. I find it very relaxing and a great way to rest from computer or phone screen.</p>
      <p class="gray-rectangle">A career I'd like to have in the nearby future is to be a Software Engineer or Web Developer because it is something I enjoy doing and also I see myself waking up every morning for the next 30-40years to work in such field. </p>
      <p class="black-rectangle">A favorite song of mine is, Feels Like Summer by Childish Gambino. But I do listen to all genres of music and like to explore them too. </p>
      <p class="yellow-rectangle">Since I moved to Brooklyn, there wasn't much time to explore, considering COVID-19. However, I like the diversity because for a multilingual like me, I have the opportunity to find people who speak natively the language I want to learn. I can learn a lot about their culture through language without even visiting the country. Of course, if there was an opportunity to visit, who wouldn't? Mostly, everyone likes to travel 😁 </p>
